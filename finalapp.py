...
def main():
    ...
    <h2 style="color:white;text-align:center;">Face Emotion Recognition WebApp</h2>
        ...
        html_temp4 = """
                             		...
                             		<h4 style="color:white;text-align:center;">This Application is developed by PankajKumar using Streamlit Framework, Opencv, Tensorflow and Keras library for demonstration purpose.</h4>
